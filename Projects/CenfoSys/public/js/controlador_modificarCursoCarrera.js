...
function editarDatos() {
    ...
    document.querySelector('#nHoras').value = curso[3]
    document.querySelector('#nCosto').value = curso[4];
    ...
    let profesoresAsociados = curso[8];
...
function obtenerDatosActualizar() {
    ...
    if (!bError) {
        ...
        profesorAsociado = guardarProfesorAsociar();

        infoCursos.push(sCodigo, sNombre, sCreditos, sHoras, sCosto, sEstado, sedesAsociadas, profesorAsociado);
        actualizarCurso(infoCursos);
        swal({
